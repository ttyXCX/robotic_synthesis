...
# Project imports
from nps.data import get_minibatch, shuffle_dataset
from nps.vizdoom_data import load_input_file
...
def add_train_cli_args(parser):
    ...
    train_group.add_argument("--train_file", type=str,
                            default = base_path + "datasets_vizdoom/vizdoom_max demo len20_train demo5_test demo1_seed123/data.hdf5", #"data/1m_6ex_karel/train.json",
                            #  default="data/1m_6ex_karel/train.json",
                             help="Path to the training data. "
                             " Default: %(default)s")
    train_group.add_argument("--val_file", type=str,
                             default = base_path + "data/1m_6ex_karel/val.json",
                            #  default="data/1m_6ex_karel/val.json",
                             help="Path to the validation data. "
                             " Default: %(default)s")
    train_group.add_argument("--vocab", type=str,
                             default = base_path + "data/1m_6ex_karel/new_vocab.vocab",
    ...
    train_group.add_argument("--result_folder", type=str,
                             default=base_path + "exps/fake_run",
